...
-- MAGIC # A header
-- MAGIC 
-- MAGIC Why you are wrong:
-- MAGIC * nothing you say makes sense
-- MAGIC * your maths is wrong
-- MAGIC * blurple isn't even a colour
-- MAGIC 
-- MAGIC [Buy the Lakehouse](https://www.databricks.com/product/data-lakehouse)
